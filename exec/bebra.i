...
# 8 "binaryTreeLib/tree.hpp" 2


# 9 "binaryTreeLib/tree.hpp"
typedef int data_t;
...
void treeCtor (BinaryTree *root, void allocData(data_t **data, size_t amount, data_t value));
void treeAppendElement (BinaryTree *root, BinaryTreeNode *parent,
                        data_t data, LR side);
void treeDeleteElement (BinaryTree *root, BinaryTreeNode *node);
void treeDtor (BinaryTree *root);

BinaryTreeNode *allocNode (data_t *data);
void allocData(data_t** data, size_t amount, data_t value);
# 2 "main.cpp" 2
...
int main()
{
    ...
    treeCtor (root, allocData);

    treeAppendElement (root, root->root, 5, LEFT);
